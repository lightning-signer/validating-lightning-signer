...
impl MyKeysManager {
	pub fn new(seed: &[u8; 32], network: Network, logger: Arc<Logger>,
			   starting_time_secs: u64, starting_time_nanos: u32) -> MyKeysManager {
...
impl KeysInterface for MyKeysManager {
	...
	fn get_channel_keys(&self, channel_id: [u8; 32], _inbound: bool, channel_value_satoshis: u64) -> InMemoryChannelKeys {
		let channel_seed = hkdf_sha256(&self.channel_seed_base, "per-peer seed".as_bytes(), &channel_id);
...
mod tests {
	...
	fn keys_test() -> Result<(), ()> {
		...
		assert!(hex::encode(&keys.funding_key[..]) == "bf36bee09cc5dd64c8f19e10b258efb1f606722e9ff6fe3267b63e2dbe33dcfc");
		assert!(hex::encode(&keys.revocation_base_key[..]) == "203612ab8275bab7916b8bf895d45b9dbb639b43d904b34d6449214e9855d345");
