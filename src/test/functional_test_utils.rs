...
pub fn create_chan_between_nodes<'a, 'b, 'c, S: ChannelKeys>(
    node_a: &'a Node<'b, 'c, S>,
    node_b: &'a Node<'b, 'c, S>,
...
pub fn create_chan_between_nodes_with_value_confirm_second<S: ChannelKeys>(
    node_recv: &Node<S>,
    node_conf: &Node<S>,
) -> (
...
pub fn create_chan_between_nodes_with_value_b<S: ChannelKeys>(
    node_a: &Node<S>,
    node_b: &Node<S>,
...
pub fn create_announced_chan_between_nodes_with_value<S: ChannelKeys>(
    nodes: &Vec<Node<S>>,
    a: usize,
    b: usize,
    channel_value_sat: u64,
...
pub fn close_channel<'a, 'b, S: ChannelKeys>(
...
pub fn send_along_route_with_hash<'a, 'b, S: ChannelKeys>(
...
pub fn send_along_route<'a, 'b, S: ChannelKeys>(
    origin_node: &Node<'a, 'b, S>,
    route: Route,
    expected_route: &[&Node<'a, 'b, S>],
    recv_value_sat: u64,
...
pub fn claim_payment_along_route<'a, 'b, S: ChannelKeys>(
    origin_node: &Node<'a, 'b, S>,
    expected_route: &[&Node<'a, 'b, S>],
    skip_last: bool,
...
pub fn claim_payment<'a, 'b, S: ChannelKeys>(
    origin_node: &Node<'a, 'b, S>,
    expected_route: &[&Node<'a, 'b, S>],
    our_payment_preimage: PaymentPreimage,
    expected_amount_sat: u64,
...
pub fn create_node_chanmgrs<'a, 'b, S: ChannelKeys>(
    node_count: usize,
    ...
    for i in 0..node_count {
        ...
        let node = ChannelManager::new(
            Network::Testnet,
            cfgs[i].fee_estimator.clone(),
            &cfgs[i].chan_monitor,
            cfgs[i].tx_broadcaster.clone(),
            cfgs[i].logger.clone(),
...
pub fn create_network<'a, 'b, S: ChannelKeys>(
    ...
    for i in 0..node_count {
        ...
        block_notifier.register_listener(
            &cfgs[i].chan_monitor.simple_monitor as &chaininterface::ChainListener,
        );
